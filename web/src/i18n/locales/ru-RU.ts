const ruRU = {
  ...
  chat: {
    title: 'Чат',
    description: 'Общайтесь с вашим AI-ботом в стиле ChatGPT',
    inputPlaceholder: 'Введите сообщение...',
    send: 'Отправить',
    selectPipeline: 'Выберите конвейер',
    noPipeline: 'Нет доступных конвейеров',
    connecting: 'Подключение...',
    connected: 'Подключено',
    disconnected: 'Отключено',
    uploadImage: 'Загрузить изображение',
    uploadFile: 'Загрузить файл',
    pasteImage: 'Вставить скриншот (Ctrl+V)',
    newChat: 'Новый чат',
    ...
    you: 'Вы',
    assistant: 'Ассистент',
    emptyState: 'Выберите конвейер и начните общение',
