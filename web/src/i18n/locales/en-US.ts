const enUS = {
  ...
  chat: {
    title: 'Chat',
    description: 'Chat with your AI bot in ChatGPT style',
    inputPlaceholder: 'Type a message...',
    send: 'Send',
    selectPipeline: 'Select a pipeline',
    noPipeline: 'No pipeline available',
    connecting: 'Connecting...',
    connected: 'Connected',
    disconnected: 'Disconnected',
    uploadImage: 'Upload image',
    uploadFile: 'Upload file',
    pasteImage: 'Paste screenshot (Ctrl+V)',
    newChat: 'New Chat',
    ...
    you: 'You',
    assistant: 'Assistant',
    emptyState: 'Select a pipeline and start chatting',
