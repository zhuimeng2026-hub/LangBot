const zhHans = {
  ...
  common: {
    ...
    wechatLoginProcessing: '正在通过微信登录...',
    wechatLoginProcessingDesc: '请稍候，正在完成登录...',
    wechatLoginSuccess: '微信登录成功',
    wechatLoginSuccessDesc: '正在跳转到 LangBot...',
    wechatLoginFailed: '微信登录失败',
    wechatLoginError: '登录失败',
    wechatLoginNoCode: '缺少授权码',
    backToLogin: '返回登录',
    backToHome: '返回首页',
  ...
  chat: {
    title: '聊天',
    description: '以 ChatGPT 风格与你的 AI 机器人对话',
