const viVN = {
  ...
  chat: {
    title: 'Trò chuyện',
    description: 'Trò chuyện với bot AI của bạn theo phong cách ChatGPT',
    inputPlaceholder: 'Nhập tin nhắn...',
    send: 'Gửi',
    selectPipeline: 'Chọn pipeline',
    noPipeline: 'Không có pipeline nào',
    connecting: 'Đang kết nối...',
    connected: 'Đã kết nối',
    disconnected: 'Đã ngắt kết nối',
    uploadImage: 'Tải ảnh lên',
    uploadFile: 'Tải tệp lên',
    pasteImage: 'Dán ảnh chụp màn hình (Ctrl+V)',
    ...
    you: 'Bạn',
    assistant: 'Trợ lý',
    emptyState: 'Chọn một pipeline và bắt đầu trò chuyện',
