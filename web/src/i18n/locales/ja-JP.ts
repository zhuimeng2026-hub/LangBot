const jaJP = {
  ...
  common: {
    ...
    wechatLoginProcessing: 'WeChatでログイン中...',
    wechatLoginProcessingDesc: 'ログインが完了するまでお待ちください...',
    wechatLoginSuccess: 'WeChatログイン成功',
    wechatLoginSuccessDesc: 'LangBotにリダイレクト中...',
    wechatLoginFailed: 'WeChatログイン失敗',
    wechatLoginError: 'ログイン失敗',
    wechatLoginNoCode: '認証コードがありません',
    backToLogin: 'ログインに戻る',
    backToHome: 'ホームに戻る',
  ...
  chat: {
    title: 'チャット',
    description: 'ChatGPTスタイルでAIボットとチャット',
    inputPlaceholder: 'メッセージを入力...',
    send: '送信',
    selectPipeline: 'パイプラインを選択',
    noPipeline: '利用可能なパイプラインがありません',
    connecting: '接続中...',
    connected: '接続済み',
    disconnected: '切断済み',
    uploadImage: '画像をアップロード',
    uploadFile: 'ファイルをアップロード',
    pasteImage: 'スクリーンショットを貼り付け (Ctrl+V)',
    newChat: '新しいチャット',
