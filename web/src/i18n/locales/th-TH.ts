const thTH = {
  ...
  common: {
    ...
    wechatLoginProcessing: 'Logging in with WeChat...',
    wechatLoginProcessingDesc: 'Please wait while we complete your login...',
    wechatLoginSuccess: 'WeChat login successful',
    wechatLoginSuccessDesc: 'Redirecting to LangBot...',
    wechatLoginFailed: 'WeChat login failed',
    wechatLoginError: 'Login Failed',
    wechatLoginNoCode: 'Missing authorization code',
  ...
  chat: {
    title: 'แชท',
    description: 'แชทกับ AI Bot ของคุณในสไตล์ ChatGPT',
    inputPlaceholder: 'พิมพ์ข้อความ...',
    send: 'ส่ง',
    selectPipeline: 'เลือก Pipeline',
    noPipeline: 'ไม่มี Pipeline ที่พร้อมใช้งาน',
    connecting: 'กำลังเชื่อมต่อ...',
    connected: 'เชื่อมต่อแล้ว',
    disconnected: 'ตัดการเชื่อมต่อแล้ว',
    uploadImage: 'อัปโหลดรูปภาพ',
    uploadFile: 'อัปโหลดไฟล์',
    pasteImage: 'วางภาพหน้าจอ (Ctrl+V)',
    newChat: 'แชทใหม่',
    ...
    you: 'คุณ',
    assistant: 'ผู้ช่วย',
    emptyState: 'เลือก Pipeline และเริ่มแชท',
    noMessages: 'ยังไม่มีข้อความ เริ่มการสนทนาเลย!',
  },
  pluginPages: {
