const esES = {
  ...
  chat: {
    title: 'Chat',
    description: 'Chatea con tu bot de IA al estilo ChatGPT',
    inputPlaceholder: 'Escribe un mensaje...',
    send: 'Enviar',
    selectPipeline: 'Seleccionar pipeline',
    noPipeline: 'No hay pipelines disponibles',
    connecting: 'Conectando...',
    connected: 'Conectado',
    disconnected: 'Desconectado',
    uploadImage: 'Subir imagen',
    uploadFile: 'Subir archivo',
    pasteImage: 'Pegar captura de pantalla (Ctrl+V)',
    newChat: 'Nuevo chat',
    ...
    you: 'Tú',
    assistant: 'Asistente',
    emptyState: 'Selecciona un pipeline y comienza a chatear',
