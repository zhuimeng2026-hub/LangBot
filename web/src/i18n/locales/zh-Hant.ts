const zhHant = {
  ...
  common: {
    ...
    wechatLoginProcessing: '正在通過微信登入...',
    wechatLoginProcessingDesc: '請稍候，正在完成登入...',
    wechatLoginSuccess: '微信登入成功',
    wechatLoginSuccessDesc: '正在跳轉到 LangBot...',
    wechatLoginFailed: '微信登入失敗',
    wechatLoginError: '登入失敗',
    wechatLoginNoCode: '缺少授權碼',
    backToLogin: '返回登入',
    backToHome: '返回首頁',
  ...
  chat: {
    title: '聊天',
    description: '以 ChatGPT 風格與你的 AI 機器人對話',
    ...
    you: '你',
    assistant: '助手',
    emptyState: '選擇一個流水線開始對話',
    noMessages: '暫無訊息，開始對話吧！',
  },
  pluginPages: {
